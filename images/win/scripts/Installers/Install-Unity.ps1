...
$jdkUrl = "https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u292-b10/OpenJDK8U-jdk_x64_windows_hotspot_8u292b10.zip"
$jdkArchPath = Start-DownloadWithRetry -Url $jdkUrl -Name "jdk.zip"
Extract-7Zip -Path $jdkArchPath -DestinationPath "${sdkInstallRoot}"
Rename-Item "${sdkInstallRoot}\jdk8u292-b10" "OpenJDK"
